...
public class Player : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        {
            _Catapult.ThrowHumans(-direction);
        ...
        _PowerUpManager.DidInstantiateHumans += humans =>
        {
            _HumanManager.HumansOnOtherSide.AddRange(humans);
        };
    }
    ...
    private void OnHumanArriveCatapult(Human human)
    {
        ...
        human.SetState(Human.HumanState.OnCatapult);
